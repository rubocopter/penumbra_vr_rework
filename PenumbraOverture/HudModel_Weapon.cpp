...
void cHudModel_WeaponMelee::Attack(cMatrixf newPose)
{
  ...
  mtxDamage = cMath::MatrixMul(cMath::MatrixInverse(cMath::MatrixScale(mfVrScale)), mtxDamage);
  ...
  mtxOldDamage = cMath::MatrixMul(cMath::MatrixInverse(cMath::MatrixScale(mfVrScale)), mtxOldDamage);
