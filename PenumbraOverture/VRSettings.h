...
public:
	...
	bool GetEnhancedVisualsEnabled() const { return mbEnhancedVisualsEnabled; }
	...
	void SetEnhancedVisualsEnabled(bool abEnabled) { mbEnhancedVisualsEnabled = abEnabled; }
